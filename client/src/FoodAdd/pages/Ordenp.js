...
const Ordenp = () => {
    ...
    return ( 
      ...
      <i className="dropdown icon"></i>
      <div className="menu">
      <Link className="ui teal button" id="btnOrdenar" to="/prueba/adminiistrador">Comida 
      </Link><br/>
         ...
         <Link className="ui teal button" id="btnOrdenar" to="/prueba/administraador">Postre
              ...
              <div className="ui two column grid ">
               ...
               <div className="column">
                ...
                <br />
                <br />
                <Link className="ui inverted green button" id="botonesprincipales" to="/restaurants/Comida">Resgistrar</Link>
                  <br />
                <br />
                
                <Link className="ui violet button" id="botonesprincipales">Buscar</Link>
                </div>
               </div>
          </div>
