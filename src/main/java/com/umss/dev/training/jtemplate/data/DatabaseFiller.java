...
public class DatabaseFiller {
    ...
    private void seedAccommodation() {
        AccommodationService.getInstance()
                .save(getNewAccommodationTest("-17.377914", "-66.15228",
        ...
        AccommodationService.getInstance()
                .save(getNewAccommodationTest("-17.368654", "-66.16329",
    ...
    private Accommodation getNewAccommodationTest(String latitude, String longitude, String description, String name,
            String phone, ReviewValueEnum rat, String category) {
