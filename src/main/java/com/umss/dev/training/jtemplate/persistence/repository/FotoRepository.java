...
public interface FotoRepository extends JpaRepository<Foto,Integer> {
	...
	@Query("SELECT new com.umss.dev.training.jtemplate.common.dto.response.FotoQuerySQL(id, url, carousel, food, home) FROM Foto WHERE restaurant_id = ?1 and carousel = true")
