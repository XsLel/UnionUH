...
public class VisitDate{
 ...
 public VisitDate(int month, int year, String month_text){
	 this.month=month;
	 this.year=year;
 ...
 public void setMonth_text(String month_text){
  ...
  public VisitDate[] generateDates(){
	        
	     
	  VisitDate[]dates =new VisitDate[12];
	 ...
	 for (int i =0; i<12; i++) {
		...
		if(i==0 && mAct !=0) {
			...
			dates[0]= new VisitDate(mAct, aAct, MONTH[mAct]); 
			...
			aAct=aAct-1;
			 ...
			 dates[i]=new VisitDate(mAnt, aAct, MONTH[mAnt]);
